...
```
ubuntu$ sudo docker buildx create --name remote_builder \
--node x86-jenk \
...
--driver docker-container tcp://10.0.102.180
```
...
sudo docker buildx build --builder=remote_builder -t test --load .
```
