...
docker buildx build \
  -t 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}-x86 \
...
docker buildx build \
  -t 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}-arm \
  --platform linux/arm64 \
  --provenance false \
  --output push-by-digest=true,type=image,push=true \
  .

docker manifest create 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH} \
  --amend 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}-x86 \
  --amend 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}-arm

docker manifest push 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}
```
...
ubuntu$ sudo docker buildx build . \
    ...
    --no-cache --push \
    -t 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH} \
    -t 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:latest 

ubuntu$ sudo docker buildx imagetools inspect 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:$COMMIT_HASH
```
