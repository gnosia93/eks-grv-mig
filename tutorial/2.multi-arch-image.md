...
```
$ aws iam create-user --user-name your-ecr-user-name

# Attach the "AmazonEC2ContainerRegistryFullAccess" policy to the user
$ aws iam attach-user-policy --user-name your-ecr-user-name --policy-arn arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryFullAccess
```
