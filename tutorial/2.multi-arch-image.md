...
sudo docker manifest create ${ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH} \
...
sudo docker manifest push ${ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}

sudo docker manifest inspect ${ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}

sudo docker buildx imagetools create -t ${ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:latest \
...
실행 테스트
```
sudo docker run ${ACCOUNT_ID}.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai -name spring-ai
```
