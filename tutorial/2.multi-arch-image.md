...
ubuntu$ sudo docker buildx build --push \
  ...
  --tag 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:0.1 .
```
...
sudo docker buildx imagetools inspect 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:buildx-latest
