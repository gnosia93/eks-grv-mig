...
sudo docker buildx imagetools create -t 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:latest 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:${COMMIT_HASH}
```
