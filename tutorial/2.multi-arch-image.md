...
ubuntu$ sudo docker buildx build --push \
  ...
  --tag 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:$COMMIT_HASH .
...
sudo docker buildx imagetools inspect 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:$COMMIT_HASH
```
...
sudo docker buildx build \
--platform linux/amd64,linux/arm64 \
-t 499514681453.dkr.ecr.ap-northeast-2.amazonaws.com/spring-ai:buildx-latest \
--push .
